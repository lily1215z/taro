    ...
    return (
        <article className="card">
            ...
            {loading ?
                ...
                <>
                    {/*{ favor ?*/}
                    {/*    <img onClick={onClickFavor} className="like-card" width="30" src="/img/like-active.png"*/}
                    {/*         alt="like"/>*/}
                    {/*    :*/}
                    {/*    <img onClick={onClickFavor} className="like-card" width="30" src="/img/like.png" alt="like"/>*/}
                    {/*}*/}
                    {
                        onAddToFavorites && <img
                            onClick={onClickFavor}
                            className="like-card"
                            width="30"
                            src={favor ? '/img/like-active.png' : '/img/like.png'}
                        />
                    }
                    ...
                    <div className="price-box d-flex justify-between">
...

                        {
                            ...
                            <img
                                onClick={onClickPlus}
                                className="plus"
                                src={isItemAdded(id) ? '/img/plus-active.png' : '/img/plus.png'}/>
                        }
